...
import { objToGame } from 'shared/util/utilFns';
import Controls from 'web/components/Controls';
import { Loader } from 'web/components/Loader';
import BottomPlayer from 'web/components/PlayerComponents/BottomPlayer';
import LeftPlayer from 'web/components/PlayerComponents/LeftPlayer';
import RightPlayer from 'web/components/PlayerComponents/RightPlayer';
import TopPlayer from 'web/components/PlayerComponents/TopPlayer';
import FBService from 'web/service/MyFirebaseService';
import { HomeTheme } from 'web/style/MuiStyles';
import { Centered, Main, TableDiv, Wind } from 'web/style/StyledComponents';

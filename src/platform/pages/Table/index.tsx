...
const Table = () => {
  ...
  const { user, gameId, tilesSize, setStage, setPlayerSeat } =
              ...
              <div className="right-player-container">
                {rightPlayer && (
                  <RightPlayer
                    ...
                    tilesSize={tilesSize}
                    lastThrown={
                      game.tBy === RightPlayerIndex ||
                      game.wM === RightPlayerIndex
                        ? game.lastT
                        : null
                    }
                  />
              ...
              <div className="bottom-player-container">
                {bottomPlayer && (
                  <BottomPlayer
                    ...
                    lastThrown={
                      game.tBy === BottomPlayerIndex ||
                      game.wM === BottomPlayerIndex
                        ? game.lastT
                        : null
                    }
                  />
              ...
              <div className="left-player-container">
                {leftPlayer && (
                  <LeftPlayer
                    ...
                    tilesSize={tilesSize}
                    lastThrown={
                      game.tBy === LeftPlayerIndex ||
                      game.wM === LeftPlayerIndex
                        ? game.lastT
                        : null
                    }
                  />
